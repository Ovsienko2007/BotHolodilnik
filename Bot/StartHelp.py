...
async def start (message):
    if message.from_user.id in userid:
        ...
        await message.answer(text=f'Привет, <b>{message.from_user.first_name}</b> 👋!\n\n'
                                  ...
                                  f'<b>Команду /home использовать только после того, как вы скинули боту геопозицию;</b>\n'
                                  f'<b>Команду /time хотя бы один пользователь должен использовать;</b>'
,
